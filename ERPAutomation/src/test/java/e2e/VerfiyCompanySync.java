...
import inboxUiPkg.CompanyPage;
import inboxUiPkg.HomePage;
import inboxUiPkg.LoginPage;

public class VerfiyCompanySync extends Helper {
	
	public VerfiyCompanySync() {}
	...
	public void companySync() {
		...
		try {
			...
			companyPage.companySync();
			
			System.out.println("Company Sync Successful");
